...
/// <summary>
/// Represent an URL builder for Ncore.
/// </summary>
public class NcoreUrlBuilder : INcoreUrlBuilder
{
    private const string BasicUrl = "/torrents.php?oldal=1&tipus=kivalasztottak_kozott&kivalasztott_tipus=";
    ...
    {
        this._stringBuilder = new StringBuilder(BasicUrl);
    ...
    public NcoreUrl Build()
    {
        ...
        this._stringBuilder.Clear().Append(BasicUrl);
